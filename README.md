...
> - 1st notebook: [````EDA(Exploratory Data Analysis)````](https://github.com/chukbert/HnM-Recommender-System/blob/main/1_EDA.ipynb)
...
> - 2nd notebook: [````Candidate generation and Model````](https://github.com/chukbert/HnM-Recommender-System/blob/main/2_Modeling.ipynb)
